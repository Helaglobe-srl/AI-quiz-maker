    ...
    if st.button("Generate Quiz"):
        ...
        try:
                ...
                for file_index, pdf_file in enumerate(uploaded_files):
                    ...
                    try:
                        ...
                        quiz, base_filename = loop.run_until_complete(
                            quiz_generator.create_quiz_from_text(pdf_text, pdf_file.name, language, num_questions)
                        )
                        ...
                        if quiz:
                            ...
                            if not combine_excel:
                                ...
                                if excel_path:
                                    ...
                                    # download button for simple format only
            ...
            if urls_list:
                ...
                for url_index, url in enumerate(urls_list):
                    ...
                    try:
                        ...
                        # process text with agents
                        quiz, base_filename = loop.run_until_complete(
                            quiz_generator.create_quiz_from_text(url_text, base_filename, language, num_questions)
                        )
            ...
            if combine_excel and all_quizzes:
                ...
                st.info(f"Quiz saved in: {combined_path}")
